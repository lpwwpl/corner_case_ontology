...
class Scenario(ScenarioGenerator):
    ...
    def scenario(self, **kwargs):
        ...
        ego_vehicles = template_ontology.EgoVehicle.instances()
...
def main():
    ...
    command = "python E:/BaiduNetdiskDownload/ls/scenario_runner-0.9.10/scenario_runner.py --openscenario ./" + s1[0][0] # In order to run this directly  change it to your scenario_runner folder
    print(command)
    os.system("python E:/BaiduNetdiskDownload/ls/scenario_runner-0.9.10/scenario_runner.py --openscenario ./" + s1[0][0])
