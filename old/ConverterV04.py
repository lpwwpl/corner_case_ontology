...
def main():
    ...
    print(s1[0][0])
    # command = "python ~/scenario_runner/scenario_runner.py --openscenario /fzi/ids/xt274/no_backup/phd/generation/" + s1[0][0]
    # os.system("python ~/scenario_runner/scenario_runner.py --openscenario /fzi/ids/xt274/no_backup/phd/generation/" + s1[0][0])
