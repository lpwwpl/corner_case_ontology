...
import time
onto_path.append("./MainOntologyV05.owl")
onto2 = get_ontology("file://MainOntologyV05.owl").load()
...
def main():
    ...
    command = "python ConverterV04.py " + filename_cut_in
    print(command)
    os.system("python ConverterV04.py " + filename_cut_in)
